...
OBJECT_FILES = obj/main.o obj/cpu.o obj/decode.o obj/opcode.o obj/memory.o obj/cartridge.o obj/timer.o obj/interrupt.o obj/graphics.o obj/display.o obj/gameboy.o
...
objects : cpu.o opcode.o decode.o memory.o cartridge.o timer.o interrupt.o graphics.o display.o gameboy.o main.o

GBemu_Debug : cpu.o opcode.o decode.o memory.o cartridge.o timer.o interrupt.o graphics.o display.o gameboy.o main.o
